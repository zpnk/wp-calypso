...
MenuData.prototype.saveMenu = function( menu, callback ) {
	...
	/**
	 * Below, we check if there are any new pages that need to be created. The
	 * post edit store requires this process to be sequential, so we build a
	 * chain of promises, each of them responsible for the creation of a page.
	 */
